...
export const TH1 = (props: TypoGraphyProps) => (
  <TypoGraphy
    size="5.5rem"
    weight={600}
    as="h1"
...
export const TH2 = (props: TypoGraphyProps) => (
  <TypoGraphy
    size="3rem"
    weight={400}
    as="h2"
...
export const TCategory = (props: TypoGraphyProps) => (
  <TypoGraphy
    size="4rem"
    weight={400}
    as="h2"
...
export const TP = (props: TypoGraphyProps) => (
  <TypoGraphy
    size="1.5rem"
    weight={400}
    as="p"
...
export const TPriceBig = (props: TypoGraphyProps) => (
  <TypoGraphy
    size="2.5rem"
    weight={700}
    as="p"
...
export const TFacetHeading = (props: TypoGraphyProps) => (
  <TypoGraphy
    size="1.5rem"
    weight={400}
    as="div"
