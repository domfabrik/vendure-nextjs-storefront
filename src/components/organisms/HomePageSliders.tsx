...
export const HomePageSliders = ({ sliders, seeAllText }: BestOfI) => {
  ...
  return (
    ...
    >
      {sliders.map((slider) => {
        ...
        const href = slider?.parent?.slug !== '__root_collection__' ? `/collections/${slider?.parent?.slug}/${slider?.slug}` : `/collections/${slider?.slug}`;
